    ...
    return (
        <PagesContainer>
            <section className="px-[7%] py-12">
                <h2 className='line-heading text-sm uppercase mb-4 text-dark200'>LETS TALK</h2>
                <div className="flex flex-wrap justify-between gap-y-4 gap-x-16">
                    <h3 className='font-medium text-2xl md:text-[2.8rem] max-w-[970px] leading-[1.35] text-Primary basis-[200px] grow'>Contact Us</h3>
                    <p className="text-dark200 text-2xl text-justify grow basis-[300px]">Thanks for your interest in Oretol. Whether you are looking to start a project, get support, or just have a general question, we want to hear from you.
                    </p>
                </div>
            </section>
