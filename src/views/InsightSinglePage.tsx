            ...
            <PagesContainer>
                {insight?.title ? (
                    <section className='px-[7%] py-12'>
                        ...
                        <div className='mt-10'>
                            <div className='relative before:w-[1.5px] before:h-[100%] before:bg-[#42BEFA] before:absolute'>
                                <div className='pl-7'>
                            ...
                            <div className="relative h-screen max-h-[600px] lg:max-h-[750px] flex items-end px-4 sm:px-[7%] py-12 overflow-hidden mt-20">
                                <ReactPlayer
                                    muted
                                    loop={true}
                                    controls={false}
