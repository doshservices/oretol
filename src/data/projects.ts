...
import hero1 from "../assets/pictures/projects/bayHero.png";
import hero3 from "../assets/pictures/projects/lakeHero.png";
import hero4 from "../assets/pictures/land-reclaim-hero.png";

import bay1 from "../assets/pictures/projects/hampton-bay/Frame 1000008022.png";
import bay2 from "../assets/pictures/projects/hampton-bay/Frame 1000008023.png";
...
import island2 from "../assets/pictures/islandImage.jpg";
import island3 from "../assets/pictures/islandImage2.jpg";
...
export const ourProjects = [
  {
    ...
    location: "Spar Road Ikate, Lekki",
    heroImg: hero1,
    projectDetails: "HAMPTON BAY AT IKATE",
    sector: "REAL ESTATE",
    serviceProvided: "CONSTRUCTION & MANAGEMENT",
  ...
  },
  {
    ...
    gallery: [islandOne, islandTwo, reclaim8, islandThree, reclaim5, islandFour, bay7, island2],
    otherGallery :[
      lake9,
      reclaim1,
      reclaim2,
  ...
  },
  {
    ...
    title: "Innovative solutions for Complex projects",
    description:
      "Hampton Lake promises the idyllic living experience. Get ready to create new memories and discoveries with family and friends in this scenic properly, right at the heart of the city of Lagos.",
    location: "Chevron Alternative Drive, Lekki",
    heroImg: hero3,
    ...
    startDate: "1, Mar 2019",
    completionDate: "1,MAR, 2026",
    details:
      "Hampton Lake stands as an epitome of luxury living along Chevron Alternative Drive in Lekki, offering an idyllic residential experience that surpasses expectations. This meticulously planned estate boasts adequate electricity and water supply, ensuring uninterrupted comfort and convenience for its esteemed residents. The well-planned road network and efficient waste disposal systems further contribute to a seamless living experience, reflecting a commitment to modern living standards. Strategically positioned at the heart of the Lekki Peninsula, Hampton Lake emphasizes the importance of ample green spaces for relaxation and recreation. The estate features a meticulously designed park, perfect for family gatherings, picnics, and children's play areas, fostering a sense of community and well-being among residents.",
